...
namespace Troco
{
    public partial class Troco : Form
    {
        ...
        private void calcularButton_Click(object sender, EventArgs e)
        {
            ...
            valorCompraTextBox.Text = valorCompra.ToString("c2");

            valorPago = Convert.ToDecimal(valorPagoTextBox.Text);
            valorPagoTextBox.Text = valorPago.ToString("c2");
            ...
            trocoLabel.Text = string.Format((moedas1 + moedas050 * 0.5 + moedas025 * 0.25 + moedas010 * 0.1 + moedas005 * 0.05 + moedas001 * 0.01).ToString("c2"));
